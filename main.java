...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        AdjMatrixEdgeWeightedDigraph graph = createGraph();
    ...
    private static AdjMatrixEdgeWeightedDigraph createGraph() throws FileNotFoundException {
        ...
        AdjMatrixEdgeWeightedDigraph graph = new AdjMatrixEdgeWeightedDigraph(stops.get(stops.size() - 1) + 1);
